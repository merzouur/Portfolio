  ...
  return (
    <div name='home' className=' w-full h-screen bg-[#192135]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#8892b0] py-4 max-w-[700px]'>Etudiant à l'ETNA, je recherche une alternance pour poursuivre mon cursus, ce portfolio vous permettra de voir les projets auquel j'ai participé et de savoir plus sur moi.</p>
            <div>
