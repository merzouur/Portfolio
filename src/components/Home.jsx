  ...
  return (
    <div name='home' className=' w-full h-screen bg-[#192135]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <div>
                <li><Link to="work" smooth={true} duration={500}><button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600' > Voir Projets 
